...
O objetivo desse repositório é catalogar os conteúdos existentes na internet sobre Flutter e organizar os conhecimentos em uma sequencia lógica para auxiliar os iniciantes.
...
É importante ressaltar que o Dart vem sofrendo melhorias consideráveis, por tanto, não é recomendado para iniciantes cursos gravados há mais de 1 ano.
...
Não é necessário ler e entender toda a documentação agora. Apenas se familiarize. Você saberá mais tarde como e quando usar.
